# Section — Eventos e reuniões

## Purpose

List past and scheduled Confederation meetings and related institutional events.

## Route(s)

- `/eventos/` — **frozen (Step 02)** — one page with two blocks: Anteriores · Agendadas  
- No `/eventos/anteriores/` subfolders in this phase
...
- Anteriores · Agendadas (same page)
